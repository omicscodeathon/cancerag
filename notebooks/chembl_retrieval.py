...
app = marimo.App(width="full", app_title="ChEMBL Ligand Retrieval")
...
@app.cell
def _(mo):
    mo.md(r"""### Pipeline to Download the Target Molecules""")
    return


@app.cell
def _(datetime, logging, new_client, os, pd, random, requests, time, tqdm):
    def setup_logging():
        """
    ...
    if __name__ == "__main__":
        main()
    return (
        automate_estrogen_receptor_data,
